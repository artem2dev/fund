					...
					<Flex w={"100%"} justify={"space-between"}>
						...
						<Flex flexGrow={0.7} flexDir={"column"}>
							<Flex flexDir={"column"} mb={"50px"}>
								...
								<Text>
									Мы стремимся увеличить уровень благотворительности в России и
									привлечь больше людей и организаций к содействию и помощи
									нуждающимся. Мы организуем различные программы и акции,
									направленные на пропаганду и популяризацию
							...
							<Flex flexDir={"column"} mb={"50px"}>
								...
								<Text>
									...
									уязвимом положении, включая детей, пожилых людей, инвалидов,
									бездомных и малоимущих. Мы осуществляем проекты, направленные
									на обеспечение им необходимых условий для жизни, включая
									питание, одежду, жилье, медицинскую помощь и социальную
									поддержку.
								</Text>
							</Flex>
							<Flex flexDir={"column"} mb={"50px"}>
								...
								<Text>
									Мы активно работаем над укреплением гражданского общества в
									России. Мы поддерживаем инициативы гражданских и общественных
									организаций, проводим образовательные программы и тренинги,
									способствующие развитию активного гражданского участия и
									формированию гражданского сознания.
								</Text>
							</Flex>
							<Flex flexDir={"column"}>
								<Text
								...
								<Text>
									Мы придерживаемся принципов прозрачности и отчетности в своей
									работе. Мы регулярно предоставляем отчеты о наших проектах,
									использовании средств и достигнутых результатах, чтобы наши
									доноры и партнеры могли уверенно доверять нам и видеть, как их
									пожертвования вносят реальную пользу.
								</Text>
							</Flex>
						</Flex>
					</Flex>
						...
						<Flex justify={"space-between"}>
							...
							>
								...
								<Text color={"#666666"} fontSize={"14px"}>
									Наша команда состоит из опытных специалистов, имеющих богатый
									опыт работы в сфере благотворительности и гражданского
									общества. Мы обладаем глубокими знаниями и пониманием проблем,
									с которыми сталкиваются нуждающиеся люди, и разрабатываем
									эффективные стратегии помощи.
								</Text>
							</Flex>
							<Flex
								w={"360px"}
								...
								flexDir={"column"}
							>
								<Image w={"50px"} h={"65px"} src={handsNHearts} pb={"20px"} />
								<Text
									color={"#1f243a"}
									fontSize={"20px"}
									fontWeight={700}
								...
								<Text color={"#666666"} fontSize={"14px"}>
									...
									уважение и поддержку как от общественности, так и от других
									благотворительных организаций. История работы и достижений
									нашего фонда является важным фактором при принятии решения о
									доверии.
								</Text>
							</Flex>
							<Flex
