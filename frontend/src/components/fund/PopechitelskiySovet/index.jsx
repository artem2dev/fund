...
const defaultText = `Шкода Ксения Анатольевна родилась 19 мая 1975 года в
					...
					<Flex w={"100%"} justify={"center"} bgColor={"#f2f5f8"}>
						<Flex w={"1133px"} p={"85px 0 70px 0"} flexDir={"column"}>
							...
							<Flex mt={"40px"} justify={"space-between"}>
								<Box pos={"relative"}>
									<Image w={"262px"} h={"315px"} src={vicePresident} />
									<Image
										position={"absolute"}
										left={0}
										top={0}
								...
								<Flex flexDir={"column"}>
									...
									>
										...
										<Text
											...
											mb={"56px"}
										>
											Вице-президент по связям с общественностью и СМИ,
										...
										<Text
											...
											lineHeight={"25px"}
										>
											Шкода Ксения Анатольевна родилась 19 мая 1975 года в
											Полтавской области (УССР). Гражданка РФ. Училась на
											филологическом факультете Харьковского госуниверситета им.
											Каразина, после чего долгие годы работала в сфере
											журналистики.
					...
					<Flex w={"100%"} justify={"center"} bgColor={"#f2f5f8"}>
						<Flex p={"35px 15px 35px 15px"} flexDir={"column"}>
							...
							<Flex align={"center"} flexDir={"column"} mt={"40px"}>
								<Box pos={"relative"} w={"262px"} mb={"35px"}>
									<Image w={"262px"} h={"315px"} src={vicePresident} />
									<Image
										position={"absolute"}
										left={0}
