							...
							<Flex direction={"column"}>
								...
								>
									<Text w={"553px"} ml={"67px"} mt={"50px"} fontSize={"18px"}>
										Благотворительность для меня это важно и просто в наше
										сложное время. Ранее я принял участие своими силами и
										средствами помогать детям, талантливым молодым, а теперь и
										защитникам нашей Родины. Не имею морального права оставаться
										безучастным. Это наши дети, это наш народ. Наша сила в
										единстве!
									</Text>
								</Box>
							</Flex>
							...
							<Flex direction={"column"}>
								...
								>
									...
									<Text p={"20px"} fontSize={"14px"}>
										...
										<br />
										<br />
										Не имею морального права оставаться безучастным. Это наши
										дети, это наш народ. Наша сила в единстве!
									</Text>
								</Box>
							</Flex>
						</Flex>
