	...
	return (
		<Box mb={20}>
			<Box
				...
				justifyContent={document.documentElement.clientWidth > 767 ? "space-between" : "center" }
			>
				<Box
					fontSize={25}
					fontWeight={600}
					...
					maxW={"650px"}
					>
					Целью нашего фонда является поддержка детей из детских домов, талантливой молодежи, а в данный момент бойцов на передовой и их семей.<br />
					<br />
